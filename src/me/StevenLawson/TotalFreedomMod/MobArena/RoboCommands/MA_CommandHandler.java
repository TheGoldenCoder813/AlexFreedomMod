...
public class MA_CommandHandler
{
    public static final String COMMAND_PATH = MA_Command.class.getPackage().getName();
    ...
    public static boolean handleCommand(CommandSender sender, Command cmd, String commandLabel, String[] args)
    {
        ...
        try
        {
            ...
            dispatcher = (MA_Command) classLoader.loadClass(String.format("%s.%s%s",
                    COMMAND_PATH,
                    COMMAND_PREFIX,
